...
(function() {
        ...
        else
        {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    (self._handlePendingRequests.bind(self))(uri);
                },
     ...
     * @private
     */
    r._handlePendingRequests = function(uri) {
     ...
     */
    r._handleLoadedXML3D = function(fivesObject, loadedDocument, loadedCB)
    {
     ...
     *  if given.
     */
    r._adjustReferences = function(node, baseURL)
    {
    ...
    r._adjustReferenceForAttribute = function(node, baseURL, attribute)
    {
    ...
    FIVES.Resources.RemoteXML3DLoader = new remoteXml3dLoader();
}());
